			...
			footer={
				...
				>
					...
					>
						...
						<a href="https://nextjs.org/" rel="noindex, nofollow">
							nextjs
						</a>{' '}
						and a little bit of{' '}
					...
					<Text
						...
						onClick={() => {
							fetch(
								'https://api.countapi.xyz/hit/mamad.dev/rr-counter'
							).then((res) => {
								res.json().then((res) => {
									showNotification({
										disallowClose: true,
										...
										autoClose: 5000,
										title: 'Told you not to',
										message: `Have fun now !! :)\n\n(I hope you enjoyed it)\nFYI: before you there were ${res.value} other victims`,
										color: 'green',
									})
								})
							})
